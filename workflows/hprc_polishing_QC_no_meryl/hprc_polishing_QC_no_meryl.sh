...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/hprc_polishing_QC_no_meryl/hprc_polishing_QC_no_meryl_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/hprc_polishing_QC_no_meryl/hprc_polishing_QC_no_meryl_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/hprc_polishing_QC_no_meryl
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/hprc_polishing_QC_no_meryl

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/hprc_polishing_QC_no_meryl/* ./
