...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/DeepPolisher/DeepPolisher_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/DeepPolisher/DeepPolisher_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/DeepPolisher
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/DeepPolisher

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/DeepPolisher/* ./
