...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/hprc_DeepPolisher/hprc_DeepPolisher_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/hprc_DeepPolisher/hprc_DeepPolisher_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/hprc_DeepPolisher
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/hprc_DeepPolisher

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/hprc_DeepPolisher/* ./
