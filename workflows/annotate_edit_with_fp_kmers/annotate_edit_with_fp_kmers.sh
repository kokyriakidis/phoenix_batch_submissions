...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/annotate_edit_with_fp_kmers/annotate_edit_with_fp_kmers_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/annotate_edit_with_fp_kmers/annotate_edit_with_fp_kmers_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/annotate_edit_with_fp_kmers
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/annotate_edit_with_fp_kmers

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/annotate_edit_with_fp_kmers/* ./
