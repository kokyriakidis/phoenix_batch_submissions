...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/get_low_coverage_FP_kmers/get_low_coverage_FP_kmers_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/get_low_coverage_FP_kmers/get_low_coverage_FP_kmers_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/get_low_coverage_FP_kmers
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/get_low_coverage_FP_kmers

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/get_low_coverage_FP_kmers/* ./
