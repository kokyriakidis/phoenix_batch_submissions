...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/meryl_union_hybrid/meryl_union_hybrid_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/meryl_union_hybrid/meryl_union_hybrid_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/meryl_union_hybrid
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/meryl_union_hybrid

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/meryl_union_hybrid/* ./
