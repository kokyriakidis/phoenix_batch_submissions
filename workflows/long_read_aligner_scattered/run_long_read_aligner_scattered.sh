...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/long_read_aligner_scattered/long_read_aligner_scattered_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/long_read_aligner_scattered/long_read_aligner_scattered_input_jsons
...
# move to working dir
mkdir -p /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/long_read_aligner_scattered
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/long_read_aligner_scattered

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/long_read_aligner_scattered/* ./
