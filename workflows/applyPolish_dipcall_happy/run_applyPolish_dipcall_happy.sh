...
mkdir -p ~/Downloads/phoenix_batch_submissions/workflows/applyPolish_dipcall_happy/applyPolish_dipcall_happy_input_jsons
cd ~/Downloads/phoenix_batch_submissions/workflows/applyPolish_dipcall_happy/applyPolish_dipcall_happy_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/phoenix_batch_executions/workflows/applyPolish_dipcall_happy
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/workflows/applyPolish_dipcall_happy/* ./
