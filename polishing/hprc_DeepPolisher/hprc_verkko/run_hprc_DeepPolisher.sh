...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/hprc_DeepPolisher/hprc_verkko/hprc_DeepPolisher_input_jsons
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/hprc_DeepPolisher/hprc_verkko/* ./
