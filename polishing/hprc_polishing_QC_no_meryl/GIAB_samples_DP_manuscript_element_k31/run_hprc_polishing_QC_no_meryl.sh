...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/hprc_polishing_QC_no_meryl/GIAB_samples_DP_manuscript_element_k31/hprc_polishing_QC_no_meryl_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/hprc_polishing/polisher_evaluation/GIAB_samples_DP_manuscript_element_k31/hprc_polishing_QC_no_meryl
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/hprc_polishing_QC_no_meryl/GIAB_samples_DP_manuscript_element_k31/* ./
...
# submit all
sbatch \
     --job-name=hprc_polishing_QC_no_meryl_GIAB_element_k31 \
     --array=[51,53]%2 \
