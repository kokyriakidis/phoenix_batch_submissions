...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/count_hets_homs_hprc_DeepPolisher_pipeline/HPRC_batch2_batch3/dipcall_input_jsons
...
# move to work dir
cd /private/groups/migalab/kkyriaki/hprc_polishing/qv_problems/HPRC_intermediate_asm/count_hets_homs_hprc_DeepPolisher

mkdir -p HPRC_batch2_batch3
cd HPRC_batch2_batch3

## get files to run in polishing folder ...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/count_hets_homs_hprc_DeepPolisher_pipeline/HPRC_batch2_batch3/* ./
