...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/applyPolish_dipcall_happy/HG002_y2_mm2_DCv1.2_R10_Dorado_hybrid_model1_GQ_filters/applyPolish_dipcall_input_jsons
...
# move to work dir
cd /private/groups/migalab/kkyriaki/hprc_polishing/hifi_ONT_combined_model/evaluation/HG002_y2_mm2_DCv1.2_R10_Dorado_hybrid_model1/GQ_filters/applyPolish_dipcall_happy

## get files to run in polishing folder ...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/applyPolish_dipcall_happy/HG002_y2_mm2_DCv1.2_R10_Dorado_hybrid_model1_GQ_filters/* ./
