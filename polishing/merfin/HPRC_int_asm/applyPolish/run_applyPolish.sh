...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/merfin/HPRC_int_asm/applyPolish/applyPolish_input_jsons
...
# move to work dir
cd /private/groups/migalab/kkyriaki/hprc_polishing/qv_problems/HPRC_intermediate_asm/merfin/applyPolish

## get files to run in polishing folder ...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/merfin/HPRC_int_asm/applyPolish/* ./
