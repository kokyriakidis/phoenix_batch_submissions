...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/hprc_polishing_QC/HPRC_int_asm_GQ_filters/hprc_polishing_QC_input_jsons
...
## on HPC...
cd /private/groups/patenlab/kkyriaki/hprc_polishing/qv_problems/HPRC_intermediate_asm/GQ_filters/hprc_polishing_QC
...
cp -r /private/groups/patenlab/kkyriaki/phoenix_batch_submissions/polishing/hprc_polishing_QC/HPRC_int_asm_GQ_filters/* ./
