...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/hprc_polishing_QC/t2t_primates/hprc_polishing_QC_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/t2t_primates_polishing/hprc_polishing_QC
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/hprc_polishing_QC/t2t_primates/* ./
