...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/DeepPolisher/minimap2_model3_platinum_test_docker_v0.1.0/hprc_polishing_QC/hprc_polishing_QC_input_jsons
...
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_deepPolisher_wf_runs/minimap2_model3_platinum_test_docker_v0.1.0/hprc_polishing_QC
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/DeepPolisher/minimap2_model3_platinum_test_docker_v0.1.0/hprc_polishing_QC/* ./
...
newpath="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_deepPolisher_wf_runs/minimap2_model3_platinum_test_docker_v0.1.0/hprc_polishing_QC/${sample_id}/hprc_polishing_QC_outputs/${file}" ; \
