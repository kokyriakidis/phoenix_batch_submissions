...
/private/groups/migalab/kkyriaki/hprc_polishing/data/HPRC_int_asm/dip_fastas/${sample}.dip.fa.gz ; done
...
gunzip /private/groups/migalab/kkyriaki/hprc_polishing/data/HPRC_int_asm/dip_fastas/*
...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/DeepPolisher/minimap2_model3_platinum_test_docker_v0.1.0/DeepPolisher_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_deepPolisher_wf_runs/minimap2_model3_platinum_test_docker_v0.1.0
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/DeepPolisher/minimap2_model3_platinum_test_docker_v0.1.0/* ./
