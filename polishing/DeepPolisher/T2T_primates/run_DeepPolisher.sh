...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/DeepPolisher/T2T_primates/DeepPolisher_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/t2t_primates_polishing/DeepPolisher/
...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/DeepPolisher/T2T_primates/* ./
