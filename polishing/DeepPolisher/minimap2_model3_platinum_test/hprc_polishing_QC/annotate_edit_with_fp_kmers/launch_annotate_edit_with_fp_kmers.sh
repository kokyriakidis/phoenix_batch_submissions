...
#SBATCH --job-name=Annotate_edit_with_fp_kmers
...
export TOIL_SLURM_ARGS="--time=6:00:00 --partition=high_priority"
...
time toil-wdl-runner \
    ...
    /private/home/kkyriaki/progs/flagger/wdls/tasks/other/annotate_edit_with_fp_kmers.wdl \
