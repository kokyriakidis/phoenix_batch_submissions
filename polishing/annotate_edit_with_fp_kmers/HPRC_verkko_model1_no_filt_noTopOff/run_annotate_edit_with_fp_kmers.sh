...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/annotate_edit_with_fp_kmers/HPRC_verkko_model1_no_filt_noTopOff/annotate_edit_with_fp_kmers_input_jsons

python3 /Users/kokyriakidis/Downloads/phoenix_batch_submissions/launch_from_table.py \
     --data_table ../hprc_verkko_samples_verkko_model1.QC.k31.csv \
...
# move to working dir
mkdir -p /private/groups/migalab/mira/hprc_polishing/hprc_int_asm/HPRC_verkko_model1_noTopOff/annotate_edit_with_fp_kmers
cd /private/groups/migalab/mira/hprc_polishing/hprc_int_asm/HPRC_verkko_model1_noTopOff/annotate_edit_with_fp_kmers

## get files
cp -r /private/groups/migalab/mira/phoenix_batch_submissions/polishing/annotate_edit_with_fp_kmers/HPRC_verkko_model1_no_filt_noTopOff/* ./
...
sbatch \
     ...
     --sample_csv hprc_verkko_samples_verkko_model1.QC.k31.csv  \
