...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/align_asm_project_blocks/DP_manuscript_merqury_stratifications/align_asm_project_blocks_input_jsons
...
## on HPC...
cd /private/groups/patenlab/kkyriaki/hprc_polishing/polisher_evaluation/Merqury_stratifications/align_asm_project_blocks

## check that github repo is up to date
git -C  /private/groups/patenlab/kkyriaki/phoenix_batch_submissions pull

## get files
cp -r /private/groups/patenlab/kkyriaki/phoenix_batch_submissions/polishing/align_asm_project_blocks/DP_manuscript_merqury_stratifications/* ./
...
sbatch \
     ...
     --wdl /private/home/kkyriaki/progs/hpp_production_workflows/QC/wdl/workflows/align_asm_project_blocks.wdl \
