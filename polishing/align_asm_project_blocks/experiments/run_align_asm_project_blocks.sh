...
cd ~/Downloads/phoenix_batch_submissions/polishing/align_asm_project_blocks/experiments/align_asm_project_blocks_input_jsons
...
## on HPC...
cd /private/groups/migalab/kkyriaki/hprc_polishing/polisher_evaluation/align_asm_project_blocks/

## check that github repo is up to date
git -C  /private/groups/migalab/kkyriaki/phoenix_batch_submissions pull

## get files
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/align_asm_project_blocks/experiments/* ./
...
sbatch \
     ...
     --sample_csv align_asm_project_blocks.csv \
