...
#SBATCH --job-name=merqury_hybrid_hprc_int_asm_k21
...
${sample_id}_raw_merqury_hybrid_k21_wg
...
${sample_id}_raw_merqury_hybrid_k21_conf
...
${sample_id}_polished_merqury_hybrid_k21_conf
