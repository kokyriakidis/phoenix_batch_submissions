...
BASE="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/meryl_hybrid_k31"
RAW_WG_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/raw_wg/${sample_id}"
POL_WG_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/pol_wg/${sample_id}"
RAW_CONF_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/raw_conf/${sample_id}"
POL_CONF_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31_unfiltered/pol_conf/${sample_id}"
...
juklucas/hpp_merqury:latest merqury.sh \
${BASE}/${sample_id}/meryl_hybrid_outputs/${sample_id}.hybrid.meryl \
/private/groups/hprc/polishing/batch3/hprc_polishing_QC/${sample_id}/hprc_polishing_QC_outputs/Raw.hap1.insideConf.subBed.fasta \
/private/groups/hprc/polishing/batch3/hprc_polishing_QC/${sample_id}/hprc_polishing_QC_outputs/Raw.hap2.insideConf.subBed.fasta \
...
time docker run --rm -u `id -u`:`id -g` \
-v /private/groups:/private/groups \
-v ${POL_CONF_OUTDIR}:/data \
juklucas/hpp_merqury:latest merqury.sh \
${BASE}/${sample_id}/meryl_hybrid_outputs/${sample_id}.hybrid.meryl \
/private/groups/hprc/polishing/batch3/hprc_polishing_QC/${sample_id}/hprc_polishing_QC_outputs/Polished.hap1.insideConf.subBed.fasta \
/private/groups/hprc/polishing/batch3/hprc_polishing_QC/${sample_id}/hprc_polishing_QC_outputs/Polished.hap2.insideConf.subBed.fasta \
