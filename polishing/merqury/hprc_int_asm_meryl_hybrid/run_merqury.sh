...
mkdir -p /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/
mkdir -p /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31/
...
# Run hybrid k21
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/
...
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k31
...
docker run --rm -u 30162:600 -v /private/groups:/private/groups -v /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21_unfiltered/pol_wg/HG04115:/data juklucas/hpp_merqury:latest merqury.sh /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/meryl_hybrid/HG04115/meryl_hybrid_outputs/meryl/HG04115.hybrid.meryl /private/groups/hprc/polishing/batch3/HG04115/hprc_DeepPolisher_outputs/HG04115_Hap1.polished.fasta /private/groups/hprc/polishing/batch3/HG04115/hprc_DeepPolisher_outputs/HG04115_Hap2.polished.fasta HG04115_polished_merqury_hybrid_k21_wg
