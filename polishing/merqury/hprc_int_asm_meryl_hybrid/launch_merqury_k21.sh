...
RAW_WG_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/raw_wg/${sample_id}"
POL_WG_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/pol_wg/${sample_id}"
RAW_CONF_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/raw_conf/${sample_id}"
POL_CONF_OUTDIR="/private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/merqury_hybrid_k21/pol_conf/${sample_id}"
