...
cd /Users/kokyriakidis/Desktop/Paten_lab/phoenix_batch_submissions/polishing/applyPolish/HPRC_samples_verkko_model2/applyPolish_input_jsons
...
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/HPRC_verkko_model2/applyPolish_pat

## get files to run in polishing folder ...
cp -r /private/groups/migalab/kkyriaki/phoenix_batch_submissions/polishing/applyPolish/HPRC_samples_verkko_model2/* ./
...
cd /private/groups/migalab/kkyriaki/hprc_polishing/hprc_int_asm/HPRC_verkko_model2/applyPolish_mat
